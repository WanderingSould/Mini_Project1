        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#tech" className="text-gray-400 hover:text-purple-400 transition-colors">
                  Tech Stack
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#workflow" className="text-gray-400 hover:text-purple-400 transition-colors">
                  How it Works
                </a>
              </li>
            </ul>
